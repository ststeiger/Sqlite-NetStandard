...
using SQLiteConnectionStringBuilder = Community.CsharpSqlite.SQLiteClient.SqliteConnectionStringBuilder;
...
using SynchronizationModes = Community.CsharpSqlite.SQLiteClient.SynchronizationModes;
...
public class Benchmark
{
    ...
    private static void TestSQLite()
    {
        ...
        con.Open();
        SQLiteCommand com = (SQLiteCommand)con.CreateCommand();
        ...
        SQLiteParameter p1 = (SQLiteParameter)com.CreateParameter();
        p1.DbType = DbType.Int64;
        com.Parameters.Add(p1);
        SQLiteParameter p2 = (SQLiteParameter)com.CreateParameter();
        ...
        using (SQLiteCommand com2 = (SQLiteCommand)con.CreateCommand())
        {
